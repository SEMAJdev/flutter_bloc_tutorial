...
class UpdateUserScreen extends StatefulWidget {
  final User user;
  final int index;
  const UpdateUserScreen({Key? key, required this.user, required this.index}) : super(key: key);
...
class _UpdateUserScreenState extends State<UpdateUserScreen> {
  ...
  void initState() {
    ...
    controllerUsername.text = widget.user.username.toString();
    controllerName.text = widget.user.firstName.toString();
    controllerEmail.text = widget.user.email.toString();
  }
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text('BloC Pattern: Update a User'),
        ),
                      ...
                      onPressed: () {
                        ...
                        if (validate) {
                          ...
                          context.read<UsersBloc>().add(
                            UpdateUsers(user: user, index: widget.index)
                          );
